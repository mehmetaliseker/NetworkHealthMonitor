...
public static class DatabaseSchemaContract
{
    public static IReadOnlyDictionary<string, IReadOnlySet<string>> ExpectedColumns { get; } =
        new Dictionary<string, IReadOnlySet<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["SchedulePlans"] = Set("Id", "Name", "TargetType", "TargetValue", "IntervalMinutes", "TimeoutMs", "MaxParallelism", "FailureThreshold", "IsActive", "Description", "LastRunAt", "NextRunAt", "LastStatus", "CreatedAt", "UpdatedAt"),
            ...
            ["DeviceIncidents"] = Set("Id", "DeviceId", "StartedAtUtc", "EndedAtUtc", "Status", "InitialFailureCount", "CurrentFailureCount", "RecoverySuccessCount", "FirstFailureAtUtc", "ConfirmedDownAtUtc", "DetectionDelaySeconds", "LastFailureAtUtc", "LastSuccessAtUtc", "DownNotificationCreatedAtUtc", "RecoveryNotificationCreatedAtUtc", "FlapCount", "CreatedAtUtc", "UpdatedAtUtc"),
            ["NotificationOutbox"] = Set("Id", "EventType", "DeviceId", "IncidentId", "PayloadJson", "DeduplicationKey", "Status", "AttemptCount", "NextAttemptAtUtc", "LockedAtUtc", "LockedBy", "LastError", "LastAttemptAtUtc", "CreatedAtUtc", "SentAtUtc", "CancelledAtUtc"),
            ...
            ["WorkerHeartbeat"] = Set("WorkerInstanceId", "MachineName", "ProcessId", "Version", "StartedAtUtc", "LastSeenAtUtc", "LastSchedulerCycleAtUtc", "LastSuccessfulPingAtUtc", "LastNotificationDispatchAtUtc", "Status", "LastError", "LastCriticalError", "LastDatabaseLockedError", "LastSchedulerException", "LastNtfyException", "AverageSchedulerCycleMs"),
