...
public sealed class AppSettings
{
    ...
    public const int MinSchedulePlanIntervalMinutes = 1;
    public const int MaxSchedulePlanIntervalMinutes = 365 * 24 * 60;
    ...
    public const int MaxFailureRetryIntervalSeconds = 1800;
    ...
    public const int MinDeviceCheckIntervalSeconds = 60;
    public const int MaxDeviceCheckIntervalSeconds = 365 * 24 * 60 * 60;
    public const int MinOfflineRecheckIntervalSeconds = 60;
    public const int MaxOfflineRecheckIntervalSeconds = 30 * 24 * 60 * 60;
    public const int DefaultOfflineRecheckIntervalSeconds = 20 * 60;
    public const int MinConfirmationRetryIntervalSeconds = 10;
    public const int MaxConfirmationRetryIntervalSeconds = 30 * 60;
    public const int MinConfirmationRetryCount = 0;
    public const int MaxConfirmationRetryCount = 10;
